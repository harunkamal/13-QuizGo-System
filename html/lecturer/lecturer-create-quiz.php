                                    ...
                                    <div class="mx-5 my-2 border-danger  text-center">
                                      <div class="form-row align-items-center">
                                        ...
                                        <div class="col-12">
                                          <?php
                                          $num = $i + 1;
                                           echo '<input type="text" name="q'.$i.'" class="form-control mb-2" id="inlineFormInput" placeholder="Question '.$num.' statement">';
                                            ?>
                                        </div>
                                          ...
                                          <div class="input-group">
                                            ...
                                            <div class="col-3 input-group-prepend">
                                              ...
                                              <div class="input-group-text">
                                                ...
                                                <?php echo '<input type="radio" name="a'.$i.'"   value="q'.$i.'a" aria-label="Radio button for following text input">'; ?>

                                              </div>

                                              <?php echo '<input type="text" name="q'.$i.'a" class="form-control" aria-label="Text input with radio button">'; ?>
                                            ...
                                            <div class="col-3 input-group-prepend">
                                              ...
                                              <div class="input-group-text">
                                                <?php echo '<input type="radio" name="a'.$i.'"   value="q'.$i.'b" aria-label="Radio button for following text input">'; ?>
                                              </div>
                                              <?php echo '<input type="text" name ="q'.$i.'b" class="form-control" aria-label="Text input with radio button">'; ?>

                                            </div>
                                            <div class="col-3 input-group-prepend">

                                              <div class="input-group-text">
                                                <?php echo '<input type="radio" name="a'.$i.'"   value="q'.$i.'c" aria-label="Radio button for following text input">'; ?>
                                              </div>
                                              <?php echo '<input type="text" name ="q'.$i.'c" class="form-control" aria-label="Text input with radio button">'; ?>

                                            </div>
                                            <div class="col-3 input-group-prepend">

                                              <div class="input-group-text">
                                                <?php echo '<input type="radio" name="a'.$i.'"   value="q'.$i.'d" aria-label="Radio button for following text input">'; ?>
                                              </div>
                                              <?php echo '<input type="text" name ="q'.$i.'d" class="form-control" aria-label="Text input with radio button">'; ?>
